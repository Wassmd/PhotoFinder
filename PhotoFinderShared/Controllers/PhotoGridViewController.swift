...
open class PhotoGridViewController<CellType: PhotoGridCell>: UIViewController, UICollectionViewDataSource, UICollectionViewDataSourcePrefetching, UICollectionViewDelegate, UISearchResultsUpdating {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var photo = viewModel.photoObject(at: indexPath)
        photo?.photoNumber = indexPath.row
        cell.photo = photo
    ...
    public func collectionView(_ collectionView: UICollectionView, prefetchItemsAt indexPaths: [IndexPath]) {
        if viewModel.shouldStartNextPageDownload(indexPaths: indexPaths) {
            viewModel.downloadPhotos()
        }
    }
    ...
    public func updateSearchResults(for searchController: UISearchController) {
        ...
        viewModel.resetAndDownload(for: text)
    }
